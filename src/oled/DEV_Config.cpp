...
uint8_t System_Init(void)
{
  ...
  SPI.begin(18, -1, 23, 5);  // CLK=18, MISO=-1, MOSI=23, CS=5
  SPI.setFrequency(10000000);  // 10MHz (zamiast SPI_CLOCK_DIV2)
  SPI.setDataMode(SPI_MODE3);
  SPI.setBitOrder(MSBFIRST);
  
  Serial.println("SPI initialized - 10MHz");
  ...
  Serial.println("I2C initialized - 400kHz");
...
note:
DEV_SPI_WriteByte(value) : hardware SPI
I2C_Write_Byte(value, cmd): hardware I2C
********************************************************************************/
